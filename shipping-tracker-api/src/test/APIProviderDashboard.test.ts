...
describe('APIProviderDashboard', () => {
  let dashboard: APIProviderDashboard;
  ...
  beforeEach(() => {
    ...
    dashboard = new APIProviderDashboard(mockAggregator, mockSmartRouter);
  });
  ...
  describe('Provider Features and Coverage', () => {
    ...
    it('should provide correct coverage information', async () => {
      ...
      const regionalProviders = statuses.filter(s => 
        s.coverage.includes('asia-pacific') || s.coverage.includes('mediterranean')
      );
