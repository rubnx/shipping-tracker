 ...
 */
export class YangMingAPIService {
  private client: AxiosInstance;
  private readonly baseUrl: string;
  private readonly apiKey: string;
  private readonly timeout: number = 12000; // Optimized for Asia-Pacific routes
   ...
   */
  private transformResponse(trackingNumber: string, data: YangMingAPIResponse): RawTrackingData {
    try {
   ...
   */
  private transformEvents(events: YangMingEvent[]): TimelineEvent[] {
   ...
   */
  private transformContainers(containers: YangMingContainer[]): Container[] {
   ...
   */
  private transformVessel(vessel?: YangMingVessel): VesselInfo | undefined {
   ...
   */
  private transformRoute(route?: YangMingRoute) {
   ...
   */
  private getRegionalTimezone(country: string): string {
   ...
   */
  private formatLocation(location: YangMingEvent['location']): string {
