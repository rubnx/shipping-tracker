...
exports.COSCOAPIService = void 0;
 ...
 */
class COSCOAPIService {
    constructor() {
        this.timeout = 15000; // Longer timeout for Asia-Pacific routes
        this.retryAttempts = 3;
        this.baseUrl = 'https://api.cosco-shipping.com/tracking';
        this.apiKey = environment_1.config.apiKeys.cosco;
        if (!this.apiKey) {
    ...
    mapContainerType(type) {
        ...
        if (typeLower.includes('high') || typeLower.includes('hc') || typeLower.includes('cube'))
            return 'HC';
        if (typeLower.includes('reefer') || typeLower.includes('rf') || typeLower.includes('冷藏'))
            return 'RF';
        if (typeLower.includes('open') || typeLower.includes('ot') || typeLower.includes('flat') || typeLower.includes('开顶'))
            return 'OT';
...
exports.COSCOAPIService = COSCOAPIService;
//# sourceMappingURL=COSCOAPIService.js.map