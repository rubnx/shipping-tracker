...
const SeaRatesAPIService_1 = require("../services/carriers/SeaRatesAPIService");
...
describe('SeaRatesAPIService', () => {
    ...
    beforeEach(() => {
        ...
        searatesService = new SeaRatesAPIService_1.SeaRatesAPIService();
    });
    ...
    describe('trackShipment', () => {
        ...
        it('should handle missing API key gracefully', async () => {
            const serviceWithoutKey = new SeaRatesAPIService_1.SeaRatesAPIService();
...
//# sourceMappingURL=SeaRatesAPIService.test.js.map