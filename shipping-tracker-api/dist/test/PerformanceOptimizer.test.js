...
describe('PerformanceOptimizer', () => {
    ...
    beforeEach(() => {
        ...
        optimizer = new PerformanceOptimizer_1.PerformanceOptimizer(mockAggregator, mockSmartRouter);
    ...
    describe('Request Batching', () => {
        it('should batch multiple requests efficiently', async () => {
            ...
            const requests = [
                { trackingNumber: 'BATCH1', trackingType: 'container' },
                { trackingNumber: 'BATCH2', trackingType: 'container' }
            ];
