...
const COSCOAPIService_1 = require("../services/carriers/COSCOAPIService");
...
describe('COSCOAPIService', () => {
    ...
    beforeEach(() => {
        ...
        service = new COSCOAPIService_1.COSCOAPIService();
    });
    ...
    describe('trackShipment', () => {
        ...
        it('should return error when API key is not configured', async () => {
            ...
            const serviceWithoutKey = new COSCOAPIService_1.COSCOAPIService();
    ...
    describe('Status and Event Mapping', () => {
        it('should map Chinese status codes correctly', () => {
            const service = new COSCOAPIService_1.COSCOAPIService();
...
//# sourceMappingURL=COSCOAPIService.test.js.map