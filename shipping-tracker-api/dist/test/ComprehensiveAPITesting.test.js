...
const ComprehensiveAPITesting_1 = require("./ComprehensiveAPITesting");
...
describe('ComprehensiveAPITesting', () => {
    ...
    beforeEach(() => {
        ...
        mockOptimizer = new PerformanceOptimizer_1.PerformanceOptimizer(mockAggregator, mockRouter);
        mockRouter = new SmartContainerRouter_1.SmartContainerRouter();
        ...
        testFramework = new ComprehensiveAPITesting_1.ComprehensiveAPITesting();
        // Replace the internal instances with mocks
        testFramework.aggregator = mockAggregator;
        testFramework.optimizer = mockOptimizer;
        testFramework.smartRouter = mockRouter;
    });
...
//# sourceMappingURL=ComprehensiveAPITesting.test.js.map