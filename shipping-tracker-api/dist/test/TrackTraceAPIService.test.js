...
const TrackTraceAPIService_1 = require("../services/carriers/TrackTraceAPIService");
...
describe('TrackTraceAPIService', () => {
    ...
    beforeEach(() => {
        ...
        trackTraceService = new TrackTraceAPIService_1.TrackTraceAPIService();
    });
    ...
    describe('trackShipment', () => {
        ...
        it('should handle missing API key gracefully', async () => {
            const serviceWithoutKey = new TrackTraceAPIService_1.TrackTraceAPIService();
...
//# sourceMappingURL=TrackTraceAPIService.test.js.map