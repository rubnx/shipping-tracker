...
describe('APIAggregator', () => {
    ...
    describe('fetchFromMultipleSources', () => {
        ...
        it('should handle rate limiting', async () => {
            ...
            const promises = Array.from({ length: 100 }, () => aggregator.fetchFromMultipleSources(trackingNumber));
...
//# sourceMappingURL=APIAggregator.test.js.map