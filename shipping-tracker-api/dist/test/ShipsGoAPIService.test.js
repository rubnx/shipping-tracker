...
const ShipsGoAPIService_1 = require("../services/carriers/ShipsGoAPIService");
...
describe('ShipsGoAPIService', () => {
    ...
    beforeEach(() => {
        ...
        shipsGoService = new ShipsGoAPIService_1.ShipsGoAPIService();
    });
    ...
    describe('trackShipment', () => {
        ...
        it('should handle missing API key gracefully', async () => {
            const serviceWithoutKey = new ShipsGoAPIService_1.ShipsGoAPIService();
...
//# sourceMappingURL=ShipsGoAPIService.test.js.map