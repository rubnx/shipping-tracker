...
const HapagLloydAPIService_1 = require("../services/carriers/HapagLloydAPIService");
...
describe('HapagLloydAPIService', () => {
    ...
    beforeEach(() => {
        ...
        service = new HapagLloydAPIService_1.HapagLloydAPIService();
    });
    ...
    describe('trackShipment', () => {
        ...
        it('should return error when API key is not configured', async () => {
            ...
            const serviceWithoutKey = new HapagLloydAPIService_1.HapagLloydAPIService();
    ...
    describe('Status and Event Mapping', () => {
        it('should map German status codes correctly', () => {
            const service = new HapagLloydAPIService_1.HapagLloydAPIService();
...
//# sourceMappingURL=HapagLloydAPIService.test.js.map