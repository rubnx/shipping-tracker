...
const YangMingAPIService_1 = require("../services/carriers/YangMingAPIService");
...
describe('YangMingAPIService', () => {
    let service;
    beforeEach(() => {
        service = new YangMingAPIService_1.YangMingAPIService();
        jest.clearAllMocks();
    });
...
//# sourceMappingURL=YangMingAPIService.test.js.map